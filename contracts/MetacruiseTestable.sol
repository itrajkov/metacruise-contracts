...
contract MetacruiseTestable is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  address[6] public _shareholders;
  uint[6] public _shares;
  ...
  function whitelistAddress(address _addressToWhitelist) public {
      whitelistedAddresses[_addressToWhitelist] = true;
  }

  // Remove address from whitelist
  function unWhitelistAddress(address _addressToWhitelist) public {
  ...
  function startWhitelist() external {
